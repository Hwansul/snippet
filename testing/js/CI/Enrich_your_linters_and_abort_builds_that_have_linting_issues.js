...
/**
 * ❌ Otherwise
 * Consider a rainy day where your production keeps crashing but the logs don’t display the error stack trace.
 * What happened ? Your code mistakenly threw a non - error object and the stack trace was lost, a good reason for banging your head against a brick wall.
 *
 * A 5 min linter setup could detect this TYPO and save your day
 */

// ❌ Anti-Pattern Example: 
// The wrong Error object is thrown mistakenly, no stack-trace will appear for this error. 
// Luckily, ESLint catches the next production bug
// To see an example screenshot, vist the hosted website.
