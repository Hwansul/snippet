...
/**
 * ❌ Otherwise
 * A UI test fails.The code seems right, the screen renders perfect pixels, what happened ? 
 * your snapshot testing just found a difference from the original document to the current received one - a single space character was added to the markdown...
 */
